...
public class advert {
    ...
    public static void main(String[] args) throws MalformedURLException, AWTException {
        ...
        caps.setCapability("build", "ChiliBankAdvert 1"); // CI/CD job or build name
        ...
        if (driver.getTitle().equals("DB Commerce")) {
            jse.executeScript("browserstack_executor: {\"action\": \"setSessionStatus\", \"arguments\": {\"status\": \"passed\", \"reason\": \"OK: The titles matched!\"}}");
        }
        else {
