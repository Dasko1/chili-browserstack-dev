...
public class ItemRestrictionsSandraNorth {

    @Test
    public void itemRestrictsionsSandraNorthTest(){
        ...
        $(By.id("divItem-ITEMPROP2")).shouldHave(Condition.text("Show Details"));
        ...
        $(By.id("divItem-ITEMPROPE")).shouldHave(Condition.text("Show Details"));
        ...
        $(By.id("divItem-ITEMPROPG")).shouldHave(Condition.text("QTY:"));
        ...
        $(By.id("divItem-ITEMPROPH")).shouldHave(Condition.text("QTY:"));
    }
}
