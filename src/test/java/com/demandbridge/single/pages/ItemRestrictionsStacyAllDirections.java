...
public class ItemRestrictionsStacyAllDirections {

    @Test
    public void itemRestrictionsStacyAllDirectionsTest(){
        ...
        Selenide.sleep(5000);
        $(By.id("A1~IP")).shouldBe(Condition.visible).click();                          // Open dropdown arrow
        $(By.id("B2~SLCT")).shouldBe(Condition.visible).click();                       // Click Candy Bars link
...
//        $(By.id("divItem-ITEMCOMBO1")).shouldHave(Condition.text("Qty:"));
//        $(By.id("divItem-ITEMCOMBO1")).shouldHave(Condition.text("Add to Cart"));
//        $(By.id("divItem-ITEMCOMBO1")).shouldHave(Condition.text("Show Details"));
...
//        $(By.id("divItem-ITEMCOMBO2")).shouldHave(Condition.text("Qty:"));
//        $(By.id("divItem-ITEMCOMBO2")).shouldHave(Condition.text("Add to Cart"));
//        $(By.id("divItem-ITEMCOMBO2")).shouldHave(Condition.text("Show Details"));
        ...
        $(By.id("divItem-ITEMPROP1")).shouldNotHave(Condition.text("Qty:"));
        $(By.id("divItem-ITEMPROP1")).shouldNotHave(Condition.text("Add to Cart"));
        $(By.id("divItem-ITEMPROP1")).shouldHave(Condition.text("Show Details"));
        ...
        $(By.id("divItem-ITEMPROP2")).shouldHave(Condition.text("Qty:"));
        ...
        $(By.id("divItem-ITEMPROP3")).shouldHave(Condition.text("Qty:"));
        $(By.id("divItem-ITEMPROP3")).shouldHave(Condition.text("Add to Cart"));
        $(By.id("divItem-ITEMPROP3")).shouldHave(Condition.text("Show Details"));
        ...
        $(By.id("divItem-ITEMPROP6")).shouldNotHave(Condition.text("Qty:"));
...
//        $(By.id("divItem-ITEMPROP8")).shouldNotHave(Condition.text("Qty:"));
...
//        $(By.id("divItem-ITEMPROPA")).shouldHave(Condition.text("Qty:"));
//        $(By.id("divItem-ITEMPROPA")).shouldHave(Condition.text("Add to Cart"));
//        $(By.id("divItem-ITEMPROPA")).shouldHave(Condition.text("Show Details"));
...
//        $(By.id("divItem-ITEMPROPB")).shouldHave(Condition.text("Qty:"));
//        $(By.id("divItem-ITEMPROPB")).shouldHave(Condition.text("Add to Cart"));
//        $(By.id("divItem-ITEMPROPB")).shouldHave(Condition.text("Show Details"));
...
//        $(By.id("divItem-ITEMPROPC")).shouldHave(Condition.text("Qty:"));
//        $(By.id("divItem-ITEMPROPC")).shouldHave(Condition.text("Add to Cart"));
//        $(By.id("divItem-ITEMPROPC")).shouldHave(Condition.text("Show Details"));
...
//        $(By.id("divItem-ITEMPROPD")).shouldHave(Condition.text("Qty:"));
//        $(By.id("divItem-ITEMPROPD")).shouldHave(Condition.text("Add to Cart"));
//        $(By.id("divItem-ITEMPROPD")).shouldHave(Condition.text("Show Details"));
...
//        $(By.id("divItem-ITEMPROPE")).shouldHave(Condition.text("Qty:"));
...
//        $(By.id("divItem-ITEMPROPG")).shouldHave(Condition.text("Show Details"));
...
//        $(By.id("divItem-ITEMPROPH")).shouldHave(Condition.text("Show Details"));
...
//        $(By.id("divItem-ITEMPROPI")).shouldHave(Condition.text("Qty:"));
//        $(By.id("divItem-ITEMPROPI")).shouldHave(Condition.text("Add to Cart"));
//        $(By.id("divItem-ITEMPROPI")).shouldHave(Condition.text("Show Details"));
...
//        $(By.id("divItem-ITEMPROPJ")).shouldHave(Condition.text("Qty:"));
//        $(By.id("divItem-ITEMPROPJ")).shouldHave(Condition.text("Add to Cart"));
//        $(By.id("divItem-ITEMPROPJ")).shouldHave(Condition.text("Show Details"));
    }
}
